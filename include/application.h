...
#define CAN_RPD0_LED0_DIR   TRISEbits.TRISE0
#define CAN_RPD0_LED0       LATEbits.LATE0
#define CAN_RPD0_LED1_DIR   TRISEbits.TRISE1
#define CAN_RPD0_LED1       LATEbits.LATE1
#define CAN_RPD0_LED2_DIR   TRISEbits.TRISE2
#define CAN_RPD0_LED2       LATEbits.LATE2
#define CAN_RPD0_LED3_DIR   TRISEbits.TRISE3
#define CAN_RPD0_LED3       LATEbits.LATE3
#define CAN_RPD0_LED4_DIR   TRISEbits.TRISE4
#define CAN_RPD0_LED4       LATEbits.LATE4
#define CAN_RPD0_LED5_DIR   TRISEbits.TRISE5
#define CAN_RPD0_LED5       LATEbits.LATE5
